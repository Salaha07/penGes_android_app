        ...
        documentReference.set(note).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    //note is added
                    Utility.showToast(NoteDetailesActivity.this,"Notes added succesfully");
                    finish();
                }else{
                    Utility.showToast(NoteDetailesActivity.this,"Failed were adding note");
                }
            }
        });
    ...
    void deleteNoteFromFirebase() {
        ...
        documentReference.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    //note is deleted
                    Utility.showToast(NoteDetailesActivity.this,"Notes deleted succesfully");
                    finish();
                }else{
                    Utility.showToast(NoteDetailesActivity.this,"Failed were deleting the note");
                }
            }
        });
    }
